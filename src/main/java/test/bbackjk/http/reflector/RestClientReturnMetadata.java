...
class RestClientReturnMetadata {
    private static final LogHelper LOGGER = LogHelper.of(RestClientReturnMetadata.class);
    ...
    public RestClientReturnMetadata(Method method) {
